...
internal class ActivityRequestPermission : BaseActivity() {
    ...
    private val requestNormalPermission = registerForActivityResult(
        ActivityResultContracts.RequestMultiplePermissions(),
        callbackNormalPermission()
    )
    private val requestOverlayPermission = registerForActivityResult(
        ActivityResultContracts.StartActivityForResult(),
        callbackOverlayPermission()
    )
    ...
    private fun sendResult() {
        val arrayDeniedPermission =
            UtilPermission.getArrayDeniedPermission(applicationContext, arrayDeniedPermission)
    ...
    private fun sendDenied(arrayDeniedPermission: Array<String>) {
        val isDeniedFirstTime = arrayDeniedPermission.any {
